...
func GetTopUpInfo(c *gin.Context) {
	...
	data := gin.H{
		...
		"invite_rebate_setting":   operation_setting.GetInviteRebateSetting(),
	}
...
func GetUserTopUps(c *gin.Context) {
	...
	if keyword != "" {
		topups, total, err = model.SearchUserTopUpHistories(userId, keyword, pageInfo)
	} else {
		topups, total, err = model.GetUserTopUpHistories(userId, pageInfo)
	}
	if err != nil {
...
func GetAllTopUps(c *gin.Context) {
	...
	if keyword != "" {
		topups, total, err = model.SearchAllTopUpHistories(keyword, pageInfo)
	} else {
		topups, total, err = model.GetAllTopUpHistories(pageInfo)
	}
	if err != nil {
		common.ApiError(c, err)
		return
